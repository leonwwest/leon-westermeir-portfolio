...
Homepage portfolio experience for Leon Westermeir. Visitor mode: Experience, with a clear contact action.

## Audience and job

Recruiters, hiring managers and engineering leads should identify Leon's Cloud/Platform/Automation direction, verify project evidence and decide whether to contact him within a short review session.
...
The final production host mapping for ibmw-automations.de depends on the existing Vercel project and domain configuration discovered during deployment.
