...
export const metadata: Metadata = {
  ...
  description: "Prüfbare DevOps- und Cloud-Platform-Projekte mit Azure, Terraform, Kubernetes, GitOps, CI/CD, Observability und Recovery.",
  ...
  openGraph: {
    ...
    description: "Azure IaC, Kubernetes GitOps und Incident Automation mit Code, CI, Observability und Runbooks.",
    images: [{ url: "/social-preview.png", width: 1280, height: 640, alt: "Leon Westermeir, DevOps und Cloud Platform Engineering" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Leon Westermeir - DevOps & Cloud Platform Engineering",
    description: "Azure IaC, Kubernetes GitOps und Incident Automation mit prüfbaren Engineering-Nachweisen.",
